...
const favFood = "cake and ice cream";
console.log(favFood);
...
const firstName = "Chinwe";
const lastName = "Nwoko";
...
function myFunction() {
    return "This function is about cake."
}
...
const myArrowFunction = () => {
    return "I like to store my arrow functions in a quiver variable."
}
...
function stringToUpper(str) {
    return stringToUpper.toUpperCase("This is a loud-a** function!")
}
